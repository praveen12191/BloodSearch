...
const Register = () => {
  ...
  const formSubmit = async (e)=>{
    ...
    console.log(userName,age,email,phoneNumber,bloodGroup,districtName,selectedState);
      ...
      <form class="max-w-sm mx-auto mt-44" onSubmit={formSubmit}>
        ...
        <div className="flex items-center gap-2">
          <label className="input input-bordered flex items-center gap-2 flex-1">
            <select className="w-full bg-transparent" defaultValue="" onChange ={(e)=>setBloodGroup(e.target.value)}>
          ...
          <label className="input input-bordered flex items-center gap-2 flex-1">
            <input type="number" placeholder="Age" className="w-full" onChange={(e)=>setAge(e.target.value)}/>
          </label>
        </div>
        <div className="flex items-center gap-2">
          <label className="input input-bordered flex items-center gap-2 flex-[1]">
          ...
          <label className="input input-bordered flex items-center gap-2 flex-1">
            <select className="w-full bg-transparent" defaultValue="" onChange={handleDistrictChange}>
              <option value="" disabled>
                Select District
              </option>
